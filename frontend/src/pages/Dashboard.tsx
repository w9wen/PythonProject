...
const Dashboard: React.FC = () => {
  ...
  const [newItem, setNewItem] = useState<NewItem>({ title: '', description: '' });
        ...
        <CreateItemForm onSubmit={handleCreateItem}>
          ...
          <FormGroup>
            ...
            <Input
              id="title"
              value={newItem.title}
              onChange={(e: ChangeEvent<HTMLInputElement>) => setNewItem({ ...newItem, title: e.target.value })}
              required
            />
          </FormGroup>
          ...
          <FormGroup>
            ...
            <TextArea
              ...
              onChange={(e: ChangeEvent<HTMLTextAreaElement>) => setNewItem({ ...newItem, description: e.target.value })}
            />
          </FormGroup>
